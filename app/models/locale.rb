class Locale < ActiveRecord::Base
  ...
  def self.default
    ...
    Locale.set_base_locale(:iso => Configurable.DEFAULT_LOCALE_ISO, :name => Configurable.DEFAULT_LOCALE_NAME, :language_id => language.id)
  end

  def self.set_base_locale(locale={:iso => "en", :name => "English"})
    language = Language.find_by(short: Configurable.DEFAULT_LANGUAGE_SHORT)
