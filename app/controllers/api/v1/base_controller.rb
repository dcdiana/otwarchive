  ...
  module V1
    class BaseController < ApplicationController
      ...
      def batch_errors(archivist, import_items)
        ...
        elsif import_items.size >= Configurable.IMPORT_MAX_WORKS_BY_ARCHIVIST
          errors << "This request contains too many items to import. A maximum of #{ Configurable.IMPORT_MAX_WORKS_BY_ARCHIVIST } " +
